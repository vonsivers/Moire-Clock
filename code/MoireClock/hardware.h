...
// Arduino pin usage
const int HOURS_STEP_PIN = 2;         //This is x-axis motor
const int HOURS_DIR_PIN = 5;

const int TOM_STEP_PIN = 3;        //This is y-axis motor
const int TOM_DIR_PIN = 6;

const int MINS_STEP_PIN = 4;         //This is z-axis motor
const int MINS_DIR_PIN = 7;

const int SEC_STEP_PIN = 12;       //This is a-axis motor
const int SEC_DIR_PIN = 13;
